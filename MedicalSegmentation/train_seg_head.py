...
# backbone = get_dino_backbone(**dino_bb_cfg)
# print("Dino backbone")
# summary(backbone)
...
dec_head_cfg_conv_lin = dict(in_channels=[embed_dim]*n_concat, 
                             ...
                             bilinear=True)
# dec_head = ConvHeadLinear(**dec_head_cfg_conv_lin)
...
# dec_head = FCNHead(**dec_head_cfg_fcn)
...
# dec_head = ConvUNet(**dec_head_cfg_unet)
...
if cluster_paths:
    ...
    data_root_pth = dino_main_pth.parent.parent / 'DataFoundationModels/brain/hcp1'
...
run_name = f'{data_root_pth.stem}_{model.decode_head.__class__.__name__}_{loss_name}'
wnadb_config = dict(backbone_name=backbone_name,
                    backbone_last_n_concat=n_concat,
                    decode_head=model.decode_head.__class__.__name__,
